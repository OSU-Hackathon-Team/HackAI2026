...
const SECTORS = [
    ...
    { id: "education", name: "Education & Non-Profit", icon: "🎓", desc: "Schools, universities, edtech, online learning, and community organizations.", color: "var(--yellow)" },
];
                                            ...
                                            >
                                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                                    <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: `${inter.color}15`, border: `1px solid ${inter.color}30`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem" }}>
                                                        {inter.id.startsWith("01") ? "🔧" : inter.id.startsWith("02") ? "📈" : inter.id.startsWith("03") ? "🤝" : inter.id.startsWith("04") ? "🚀" : inter.id.startsWith("05") ? "🩺" : inter.id.startsWith("06") ? "🎨" : inter.id.startsWith("07") ? "⚖️" : inter.id.startsWith("08") ? "💼" : inter.id.startsWith("09") ? "🔩" : inter.id.startsWith("10") ? "📊" : inter.id.startsWith("11") ? "💻" : inter.id.startsWith("12") ? "📦" : inter.id.startsWith("13") ? "🍎" : inter.id.startsWith("14") ? "🔍" : inter.id.startsWith("15") ? "🍿" : inter.id.startsWith("16") ? "🕵️" : inter.id.startsWith("17") ? "♾️" : inter.id.startsWith("18") ? "🐧" : inter.id.startsWith("19") ? "🎓" : inter.id.startsWith("20") ? "G" : inter.id.startsWith("21") ? "M" : "🏕️"}
